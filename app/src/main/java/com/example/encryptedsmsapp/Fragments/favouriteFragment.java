...
import com.example.encryptedsmsapp.Adapters.FavAdapter;
...
public class favouriteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView rvContacts = (RecyclerView) view.findViewById(R.id.favList);
        favourites = databaseHelper.getUserFavourites(account);
        FavAdapter adapter = new FavAdapter(favourites);
